  ...
  <section id="middle">
  	<div id="container-main">
		...
		<div class="speedbar">
        	<div class="speedbar-nav"> <a href="{$adminurl}/dashboard.php">{$site_name} Admin Panel</a> &rsaquo; Posts &rsaquo; Posts Reports</div> 
        </div>
      ...
      <div class="grid-1">
           ...
           <div class="content-gird">
				...
				{section name=i loop=$posts}
				   <tr class="item">
                        <td class="subject">{$posts[i].RID}</td>
                        ...
                        <td><span class="published">{if $posts[i].reason eq "1"}{$lang208}{elseif $posts[i].reason eq "2"}{$lang209}{elseif $posts[i].reason eq "3"}{$lang210}{elseif $posts[i].reason eq "4"}{$lang211}{/if}</span></td>
						...
						<td class="name">
							<ul class="button-list-1">
								<li><a class="button-a red" href="{$adminurl}/posts_reports.php?delete=1&RID={$posts[i].RID}&page={$page}"><span class="del icon-white"></span></a></li>
						    </ul>
						</td>
                    </tr>
				 {/section}
