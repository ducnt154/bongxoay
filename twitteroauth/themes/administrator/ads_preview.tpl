...
<body>
  ...
  <section id="middle">
		...
		<div class="speedbar">
        	<div class="speedbar-nav"> <a href="{$adminurl}/dashboard.php">{$site_name} Admin Panel</a> &rsaquo; Advertising &rsaquo; Preview Ad #{$ad.AID}</div> 
        </div>
...
<br>
<br>
	{insert name=get_advertisement value=var AID=$ad.AID}		   
