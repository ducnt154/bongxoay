    <div class="section-2">
        <div class="wrap">
            <ul class="info footer-items">
                <li>&copy; 2013 <a style="color: #fff" href="{$baseurl}">{$site_name|stripslashes}</a></li>
...
{/if}
   ...
   <!--<a target="_blank" href="{$baseurl}/channels/bong-hong"><img src="{$baseurl}/images/banner/valentine.jpg" id="banner_doc"></a>-->
...
{/if}
    ...
    {literal}
    <!--<p id="giacat">
        <a href=""><img src="../images/banner/gia-cat-du.gif"></a>
    </p>-->
    <p id="back-top">
