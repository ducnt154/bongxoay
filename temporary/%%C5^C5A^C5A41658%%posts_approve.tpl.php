<?php /* Smarty version 2.6.6, created on 2014-04-21 00:00:38
         compiled from administrator/posts_approve.tpl */ ?>
...
/dashboard.php"><?php echo $this->_tpl_vars['site_name']; ?>
 Admin Panel</a> &rsaquo; Posts &rsaquo; Approve Posts</div> 
        </div>
...
"><span class="edits icon-white"></span></a></li>
								<li><a class="button-a red" href="<?php echo $this->_tpl_vars['adminurl']; ?>
/posts_approve.php?approve=1&PID=<?php echo $this->_tpl_vars['posts'][$this->_sections['i']['index']]['PID']; ?>
&page=<?php echo $this->_tpl_vars['page']; ?>
"><span class="open icon-white"></span></a></li>
								<li><a class="button-a red" href="<?php echo $this->_tpl_vars['adminurl']; ?>
/posts_approve.php?delete=1&PID=<?php echo $this->_tpl_vars['posts'][$this->_sections['i']['index']]['PID']; ?>
&page=<?php echo $this->_tpl_vars['page']; ?>
