<?php /* Smarty version 2.6.6, created on 2014-07-08 22:48:21
         compiled from administrator/header.tpl */ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
<body>
 ...
 <header>
      ...
      <!-- Logo -->
	  <h1><a href="<?php echo $this->_tpl_vars['adminurl']; ?>
" class="logo"><?php echo $this->_tpl_vars['site_name']; ?>
</a></h1><div style="color:#fff;padding:12px;float:left;font-size:13pt;"> - Visit <a href="<?php echo $this->_tpl_vars['baseurl']; ?>
" style="color:#f00;"><?php echo $this->_tpl_vars['site_name']; ?>
</a></div>
      <!-- Logo end -->
