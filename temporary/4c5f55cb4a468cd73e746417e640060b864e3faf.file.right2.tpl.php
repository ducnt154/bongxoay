<?php /* Smarty version Smarty-3.1.16, created on 2014-03-26 11:01:35
         compiled from "/var/www/html/bongxoay/themes/right2.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1514771025531044306c6986-26400505%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4c5f55cb4a468cd73e746417e640060b864e3faf' => 
    array (
      0 => '/var/www/html/bongxoay/themes/right2.tpl',
      1 => 1395800257,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1514771025531044306c6986-26400505',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_53104430a88e37_27500779',
  'variables' => 
  array (
    'FACEBOOK_PROFILE' => 0,
    'baseurl' => 0,
...
<?php if ($_valid && !is_callable('content_53104430a88e37_27500779')) {function content_53104430a88e37_27500779($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/var/www/html/bongxoay/smarty/libs/plugins/modifier.truncate.php';
...
" data-send="false" data-width="290" data-show-faces="false" data-colorscheme="dark"></div>
    ...
    <div id="post-gag-stay" class="_badge-sticky-elements" data-y="60">
        <div class="custom-block">
            <div class="muonxem"><a href="<?php echo $_smarty_tpl->tpl_vars['baseurl']->value;?>
...
/images/readmore.png">--></a></span>
    ...
    <div>
        <?php if ($_smarty_tpl->tpl_vars['recommended']->value=="2"&&$_smarty_tpl->tpl_vars['cname2']->value!="hau-truong") {?>
        <div id="post-gag-stay" class="_badge-sticky-elements" data-y="60">
...
<?php }?></span></a><br>
                        Bởi: <a style="color: #fea700" href="<?php echo $_smarty_tpl->tpl_vars['baseurl']->value;?>
...
"><?php echo smarty_modifier_truncate(stripslashes($_smarty_tpl->tpl_vars['hoibua']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['username']),20,"...",true);?>
</a>
                        <span style="color:#999999;font-size: 11px ;font-weight: normal"><?php echo insert_get_time_to_days_ago(array('time' => $_smarty_tpl->tpl_vars['hoibua']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['time_added']),$_smarty_tpl);?>
</span><br>
                        <span style="color:#999999;font-size: 11px ;font-weight: normal;"><?php echo $_smarty_tpl->tpl_vars['hoibua']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['postviewed'];?>
 lượt xem</span>
                    </div>
                    <?php endfor; endif; ?>
...
"><?php echo smarty_modifier_truncate(stripslashes($_smarty_tpl->tpl_vars['binhbua']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['username']),20,"...",true);?>
                        ...
                        <span style="color:#999999;font-size: 11px ;font-weight: normal"><?php echo insert_get_time_to_days_ago(array('time' => $_smarty_tpl->tpl_vars['binhbua']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['time_added']),$_smarty_tpl);?>
</span><br>
                        <span style="color:#999999;font-size: 11px ;font-weight: normal;"><?php echo $_smarty_tpl->tpl_vars['binhbua']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['postviewed'];?>
 lượt xem</span>
                    </div>
                    <?php endfor; endif; ?>
