<?php /* Smarty version Smarty-3.1.16, created on 2014-03-26 11:01:53
         compiled from "/var/www/html/bongxoay/themes/right.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14362063875310443771f566-77159629%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ff537d079832b3356992b5f83d2510c6177f95c8' => 
    array (
      0 => '/var/www/html/bongxoay/themes/right.tpl',
      1 => 1395800257,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14362063875310443771f566-77159629',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_53104437a90087_74684826',
  'variables' => 
  array (
    'newsrelated' => 0,
    'baseurl' => 0,
...
<?php if ($_valid && !is_callable('content_53104437a90087_74684826')) {function content_53104437a90087_74684826($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/var/www/html/bongxoay/smarty/libs/plugins/modifier.truncate.php';
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['i']['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['newsrelated']->value) ? count($_loop) : max(0, (int) $_loop); unset($_loop);
...
?>
                    <?php if ($_smarty_tpl->tpl_vars['newsrelated']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['youtube_key']!='') {?>
                    <li>
                        <div style="height: 74px">
                            <a class="wrap" href="<?php echo $_smarty_tpl->tpl_vars['baseurl']->value;?>
<?php echo $_smarty_tpl->tpl_vars['postfolder']->value;?>
<?php echo $_smarty_tpl->tpl_vars['newsrelated']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['PID'];?>
/<?php if ($_smarty_tpl->tpl_vars['SEO']->value=="1") {?><?php echo makeseo($_smarty_tpl->tpl_vars['newsrelated']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['story']);?>
.html<?php }?>"  onclick="GAG.GA.track('RelatedContent', 'Clicked-Post-Sidebar', 'Position-1', 1)"  >
                            <img class="hot" src="http://img.youtube.com/vi/<?php echo $_smarty_tpl->tpl_vars['newsrelated']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['youtube_key'];?>
/1.jpg" alt="<?php echo stripslashes($_smarty_tpl->tpl_vars['newsrelated']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['story']);?>
" />
                            <span><?php echo smarty_modifier_truncate(stripslashes($_smarty_tpl->tpl_vars['newsrelated']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['story']),60,"...",true);?>
</span><br>
                            <span style="color:#999999;font-size: 11px ;font-weight: normal"><?php echo insert_get_time_to_days_ago(array('time' => $_smarty_tpl->tpl_vars['newsrelated']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['time_added']),$_smarty_tpl);?>
</span><br>
                            <span style="color:#999999;font-size: 11px ;font-weight: normal"><?php echo $_smarty_tpl->tpl_vars['newsrelated']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['postviewed'];?>
 lượt xem</span>
                            </a>
                        </div>
                    </li>
                    <?php } else { ?>
                        <li class="text_cungloai" style="padding: 5px">
                            <img style="border: none;padding-right: 4px;float: left;margin-top: 5px;height: 7px" src="<?php echo $_smarty_tpl->tpl_vars['baseurl']->value;?>
/images/dot-icon.png">
...
/<?php if ($_smarty_tpl->tpl_vars['SEO']->value=="1") {?><?php echo makeseo($_smarty_tpl->tpl_vars['newsrelated']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['story']);?>
.html<?php }?>"  onclick="GAG.GA.track('RelatedContent', 'Clicked-Post-Sidebar', 'Position-1', 1)"  >
                            <span> <?php if ($_smarty_tpl->tpl_vars['truncate']->value=="1") {?><?php echo smarty_modifier_truncate(stripslashes($_smarty_tpl->tpl_vars['newsrelated']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['story']),87,"...",true);?>
<?php } else { ?><?php echo stripslashes($_smarty_tpl->tpl_vars['newsrelated']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['story']);?>
<?php }?></span><br>
                            <span style="color:#999999;font-size: 11px ;font-weight: normal"><?php echo insert_get_time_to_days_ago(array('time' => $_smarty_tpl->tpl_vars['newsrelated']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['time_added']),$_smarty_tpl);?>
</span> |
                            <span style="color:#999999;font-size: 11px ;font-weight: normal"><?php echo $_smarty_tpl->tpl_vars['newsrelated']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['postviewed'];?>
...
?>
                    <div style="height:74px">
                        <a title="<?php echo $_smarty_tpl->tpl_vars['video']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['title'];?>
" class="wrap" href="<?php echo $_smarty_tpl->tpl_vars['baseurl']->value;?>
<?php echo $_smarty_tpl->tpl_vars['postfolder']->value;?>
