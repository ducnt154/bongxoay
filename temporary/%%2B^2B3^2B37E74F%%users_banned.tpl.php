<?php /* Smarty version 2.6.6, created on 2014-04-21 00:01:23
         compiled from administrator/users_banned.tpl */ ?>
...
/dashboard.php"><?php echo $this->_tpl_vars['site_name']; ?>
 Admin Panel</a> &rsaquo; Users &rsaquo; Banned Users</div> 
        </div>
...
"><span class="edits icon-white"></span></a></li>
								<li><a class="button-a red" href="<?php echo $this->_tpl_vars['adminurl']; ?>
/users_banned.php?approve=1&ID=<?php echo $this->_tpl_vars['users'][$this->_sections['i']['index']]['USERID']; ?>
&page=<?php echo $this->_tpl_vars['page']; ?>
"><span class="open icon-white"></span></a></li>
								<li><a class="button-a red" href="<?php echo $this->_tpl_vars['adminurl']; ?>
/users_banned.php?delete=1&ID=<?php echo $this->_tpl_vars['users'][$this->_sections['i']['index']]['USERID']; ?>
&page=<?php echo $this->_tpl_vars['page']; ?>
