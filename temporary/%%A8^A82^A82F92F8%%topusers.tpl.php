<?php /* Smarty version 2.6.6, created on 2014-07-05 02:47:26
...
" style="font-size: 16px; font-weight: bold; padding-bottom: 5px; margin-bottom: 6px; border-bottom: 1px solid rgb(242, 242, 242); display: block;"><?php echo $this->_tpl_vars['users'][$this->_sections['i']['index']]['username']; ?>
					...
					<a href="<?php echo $this->_tpl_vars['baseurl']; ?>
/user/<?php echo $this->_tpl_vars['users'][$this->_sections['i']['index']]['username']; ?>
" style="font-size: 12px; color: rgb(68, 68, 68);">Rank: <?php echo $this->_tpl_vars['users'][$this->_sections['i']['index']]['rank']; ?>
&nbsp;&nbsp;<span style="color: rgb(238, 238, 238);">|</span>&nbsp;&nbsp;Posts: <?php echo $this->_tpl_vars['users'][$this->_sections['i']['index']]['posts']; ?>
&nbsp;&nbsp;<span style="color: rgb(238, 238, 238);">|</span>&nbsp;&nbsp;Views: <?php echo $this->_tpl_vars['users'][$this->_sections['i']['index']]['yourviewed']; ?>
&nbsp;&nbsp;<span style="color: rgb(238, 238, 238);">|</span>&nbsp;&nbsp;Points: <?php echo $this->_tpl_vars['users'][$this->_sections['i']['index']]['points']; ?>
</a>
					</div>
					<div class="clear"></div>
