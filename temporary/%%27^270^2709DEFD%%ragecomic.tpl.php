<?php /* Smarty version 2.6.6, created on 2014-07-08 13:13:40
         compiled from ragecomic.tpl */ ?>
﻿<!--<script src="<?php echo $this->_tpl_vars['baseurl']; ?>
/comic/jquery.mousewheel.max.js" type="text/javascript">-->
<script src="<?php echo $this->_tpl_vars['baseurl']; ?>
...
<script src="<?php echo $this->_tpl_vars['baseurl']; ?>
/comic/rage.min.js" type="text/javascript"></script>
<link href="<?php echo $this->_tpl_vars['baseurl']; ?>
...
/comic/packs/neutral/images/Thoughtful.png" style="width: 66px;" /></div>
                <div>
                    ...
                    bạn có thể đăng lên xungheonline.com hoặc lưu ảnh về máy.
                </div>
...
/comic/cdn/img/ragecomic/delete.png" />
                ...
                <div id="canvasControllerDiv" class="controllerSubset">
                    <span title='Hoàn thành' id='exportCanvas' class='menuIcon'>
                        <img alt="" src="<?php echo $this->_tpl_vars['baseurl']; ?>
/comic/cdn/img/ragecomic/disk.png" /></span>
                </div>
                <div style="clear: both">
                </div>
            </div>
...
/comic/cdn/img/ragecomic/watermark.png"
	...
	<div style="margin:5px auto;width:800px;">
		<div class="fb-like" data-href="http://bongxoay.com/comic/" data-width="500" data-show-faces="false" data-send="false"></div>
		<div class="fb-comments" data-href="http://bongxoay.com/comic/" data-width="800"></div>
	</div>
</div>
<div id="footer" class="">
<?php echo '
	<script type="text/javascript">
        $(document).ready(function () {
            RageComic.initialize({
                packRoot: "http://bongxoay.com/comic/",
                siteUrl: "",
                builderUrl: "http://bongxoay.com/comic/",
                cdnRoot: "http://bongxoay.com/comic/cdn/"
            });
        });
