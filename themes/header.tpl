...
<!--    <script type="text/javascript" src="{$baseurl}/js/moo-clientcide-1.3.js"></script>-->
 ...
 <!--   <script type="text/javascript" src="{$baseurl}/js/likeme.js"></script>
    ...
    <div id="head-bar">
        ...
        <ul id="nav" class="main-menu" style="overflow:visible">
            ...
            <li style="margin-right: 5px;">
                <a href="{$baseurl}/meme"><img src="{$baseurl}/images/menu/cheanh.png" style="margin-bottom:-14px; padding-right:5px;" />
        ...
        <ul class="main-2-menu">
            ...
            <li>
                ...
                <a class="add-login {if $menu eq 6}current{/if}" href="https://www.facebook.com/dialog/permissions.request?app_id={$FACEBOOK_APP_ID}&display=page&next={$baseurl}/&response_type=code&fbconnect=1&perms=email,user_birthday,user_about_me,publish_stream"><span class="add-login {if $menu eq 6}current_active{/if}">{$lang197}</span></a>
        ...
        <div class="hot-menu">
          <!--  <div style="text-decoration:blink;float: left;margin-right: 5px"><img src="{$baseurl}/images/gamebai888/choingay.gif" alt=""></div>
            ...
            <a style="margin-right: 15px" title="Phỏm" href="http://gamebai888.com/phom.888" target="_blank"><img height="50px" src="{$baseurl}/images/gamebai888/phom.png" /></a>-->
               <div class="menu-icon">
               <!-- <a href="#">Ngôi sao</a>-->
               <a href="{$baseurl}/channels/hau-truong">Hậu trường</a> |
               <a href="{$baseurl}/channels/bong-hong">Mỹ nhân</a> |
               <a href="{$baseurl}/channels/link-sopcast">Link sopcast</a> |
               <a target="_blank" href="{$baseurl}/livescores.html">Livescore</a>
               </div>
            <div style="float:right;margin-top: -42px;margin-top: -40px\9;">
            <!--<span style="font-size: 13px;padding-left: 185px;">Chế ảnh hài bóng đá tại <a style="color: #24bbff" href="{$baseurl}/meme">BÓNG XOÁY</a></span>-->
