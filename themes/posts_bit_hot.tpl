                            ...
                            <div class="img-wrap">
                                ...
                                {else}
                                	{if $posts[i].pic ne ""}
                                       ...
                                       <!--<center>
                                        <a target="_blank">{insert name=return_youtube2 value=a assign=youtube youtube=$posts[i].youtube_key}{$youtube}</a>
                                        </center>-->
                                       <center style="height:350px">
                                        ...
                                        {elseif $posts[i].dai_key != ""}
                                        <center>
                                            {insert name=return_dai2 value=a assign=dai dai=$posts[i].dai_key}{$dai}
                                        </center>
                            ...
                            <div class="info b9gcs-stop" id="action-{$posts[i].PID}" >
                                ...
                                <p>
									...
									<a title="Lượt xem"><span class="viewed">Lượt xem: {$posts[i].postviewed}</span></a> |
                                        Chuyên mục: <a href="{$baseurl}/channels/{$posts[i].cname|makeseo}"" title="{$posts[i].cname}"><span>{$posts[i].cname}</span></a>
                                    </span>
                                ...
                                <div class="sharing-box ">
                                    <div class="fb-like" data-href="{$baseurl}{$postfolder}{$posts[i].PID}/{if $SEO eq "1"}{$posts[i].story|makeseo}.html{/if}" data-layout="button" data-action="like" data-show-faces="true" data-share="true"></div>
                                </div>
