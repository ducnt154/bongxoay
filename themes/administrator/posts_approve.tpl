  ...
  <section id="middle">
  	<div id="container-main">
		...
		<div class="speedbar">
        	<div class="speedbar-nav"> <a href="{$adminurl}/dashboard.php">{$site_name} Admin Panel</a> &rsaquo; Posts &rsaquo; Approve Posts</div> 
        </div>
		...
		<!--Table Styling-->
      <div class="grid-1">
           <div class="title-grid">Posts Awaiting Validiation</div>
				   ...
				   <tr class="item">
                        ...
                        <td class="name">
							<ul class="button-list-1">
								...
								<li><a class="button-a red" href="{$adminurl}/posts_approve.php?approve=1&PID={$posts[i].PID}&page={$page}"><span class="open icon-white"></span></a></li>
								<li><a class="button-a red" href="{$adminurl}/posts_approve.php?delete=1&PID={$posts[i].PID}&page={$page}"><span class="del icon-white"></span></a></li>
						    </ul>
						</td>
                    </tr>
				 {/section}
