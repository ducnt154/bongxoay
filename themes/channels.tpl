        ...
        <div class="main-filter ">
            ...
            <div id="use-tips">
                <div id="view-info" class="list-tips">
                    <img style="height: 45px;float: left" src="{$baseurl}/images/emotion/nice.png">
        ...
        <div id="content" listPage="hot">
            <div id="entries-content" class="list">
                <ul id="entries-content-ul" class="col-1">
                    ...
                    {if $cname2 eq "video-bong-da"}
                        {include file="bongxoaytv.tpl"}
                    {elseif $cname2 eq "link-sopcast"}
                        {include file="sopcast.tpl"}
                    {elseif $cname2 eq "my-nham"}
                        {include file="mynhan.tpl"}
                        {else}
			...
			{/literal}
                ...
                <div id="paging-buttons" class="paging-buttons">
                    {if $tpp ne ""}
                    <a href="{$baseurl}/channels/{$cname2|makeseo}/?page={$tpp}" class="previous">&laquo; {$lang166}</a>
                {else}
                <a href="#" onclick="return false;" class="previous disabled">&laquo; {$lang166}</a>
                {/if}
                {if $tnp ne ""}
                <a href="{$baseurl}/channels/{$cname2|makeseo}/?page={$tnp}" class="older">{$lang167} &raquo;</a>
                {else}
...
{if $cname2 ne "video-bong-da"}
{if $cname2 ne "ngoi-sao"}
